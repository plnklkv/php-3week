...
{
    //наим валидируемого поля
    protected string $field = '';
    //знач валидируемого поля
    protected $value;
    //доп аргументы
    ...
    //если правило валидации не прошло, то возвращается сообщение об ошибке
    ...
    //основное правило валидации
    //его должны переопределить классы-потомки
