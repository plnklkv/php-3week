...
class Route
{
    //использ методов трейта
    use SingletonTrait;

    //св-во для хранения текущего маршрута
    private string $currentRoute = '';
    private $currentHttpMethod;

    //св-во для префикса для всех маршрутов
    private string $prefix = '';

    //классы для исп-ния внешнего маршрутизатора
    private RouteCollector $routeCollector;

    //доб маршрут, устан его текущим и возвращает объект
    ...
    //доб префикс для обозначенных маршрутов
    ...
    //доб middlewares для текущего маршрута
    ...
    public function start(): void
    {
        ...
        switch ($routeInfo[0]) {
            ...
            case Dispatcher::FOUND:
                ...
                //вызов обработки всех Middleware
